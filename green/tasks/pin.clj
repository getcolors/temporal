...
(defn blue-pinned-meta [sha]
  (str "# dependencies = [\"package-temporal-blue\", \"blue\", \"package-once-blue\", \"colors-compute-blue\"]\n"
       "#\n"
       "# [tool.uv.sources]\n"
